...
# calendar é usado para coisas genéricas de calnedários e datas.
...
# nome_primeiro_dia, ultimo_dia = calendar.monthrange(2022, 12)
# print(calendar.day_name[nome_primeiro_dia])
